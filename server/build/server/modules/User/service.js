...
var User = /** @class */ (function () {
    ...
    User.prototype.getById = function (cd_usuario_pk) {
        return model.User.findOne({
            where: { cd_usuario_pk: cd_usuario_pk }
        })
    ...
    User.prototype.update = function (cd_usuario_pk, user) {
    ...
    User.prototype.delete = function (cd_usuario_pk) {
